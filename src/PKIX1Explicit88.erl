...
#{type:=Cindex1,values:=Cindex2} = Val,
...
#{type:=Cindex1,value:=Cindex2} = Val,
...
#{tbsCertificate:=Cindex1,signatureAlgorithm:=Cindex2,signature:=Cindex3} = Val,
...
Res1 = #{tbsCertificate=>Term1,signatureAlgorithm=>Term2,signature=>Term3},
Res1.
...
#{serialNumber:=Cindex2,signature:=Cindex3,issuer:=Cindex4,validity:=Cindex5,subject:=Cindex6,subjectPublicKeyInfo:=Cindex7} = Val,
Cindex1 = case Val of
  #{version:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex8 = case Val of
  #{issuerUniqueID:=Cindex8_0} -> Cindex8_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex9 = case Val of
  #{subjectUniqueID:=Cindex9_0} -> Cindex9_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex10 = case Val of
  #{extensions:=Cindex10_0} -> Cindex10_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{version=>Term1,serialNumber=>Term2,signature=>Term3,issuer=>Term4,validity=>Term5,subject=>Term6,subjectPublicKeyInfo=>Term7},
Res2 = case Term8 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{issuerUniqueID=>Term8}
end,
Res3 = case Term9 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{subjectUniqueID=>Term9}
end,
Res4 = case Term10 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{extensions=>Term10}
end,
Res4.
...
#{notBefore:=Cindex1,notAfter:=Cindex2} = Val,
...
Res1 = #{notBefore=>Term1,notAfter=>Term2},
Res1.
...
#{algorithm:=Cindex1,subjectPublicKey:=Cindex2} = Val,
...
Res1 = #{algorithm=>Term1,subjectPublicKey=>Term2},
Res1.
...
#{extnID:=Cindex1,extnValue:=Cindex3} = Val,
Cindex2 = case Val of
  #{critical:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{extnID=>Term1,critical=>Term2,extnValue=>Term3},
Res1.
...
#{tbsCertList:=Cindex1,signatureAlgorithm:=Cindex2,signature:=Cindex3} = Val,
...
Res1 = #{tbsCertList=>Term1,signatureAlgorithm=>Term2,signature=>Term3},
Res1.
...
#{signature:=Cindex2,issuer:=Cindex3,thisUpdate:=Cindex4} = Val,
Cindex1 = case Val of
  #{version:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex5 = case Val of
  #{nextUpdate:=Cindex5_0} -> Cindex5_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex6 = case Val of
  #{revokedCertificates:=Cindex6_0} -> Cindex6_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex7 = case Val of
  #{crlExtensions:=Cindex7_0} -> Cindex7_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
enc_TBSCertList_revokedCertificates_SEQOF(Val, TagIn) ->
   #{userCertificate:=Cindex1,revocationDate:=Cindex2} = Val,
Cindex3 = case Val of
  #{crlEntryExtensions:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{signature=>Term2,issuer=>Term3,thisUpdate=>Term4},
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{version=>Term1}
end,
Res3 = case Term5 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{nextUpdate=>Term5}
end,
Res4 = case Term6 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{revokedCertificates=>Term6}
end,
Res5 = case Term7 of
  asn1_NOVALUE -> Res4;
  _ -> Res4#{crlExtensions=>Term7}
end,
Res5.
...
Res1 = #{userCertificate=>Term1,revocationDate=>Term2},
Res2 = case Term3 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{crlEntryExtensions=>Term3}
end,
Res2.
...
#{algorithm:=Cindex1} = Val,
Cindex2 = case Val of
  #{parameters:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{algorithm=>Term1},
Res2 = case Term2 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{parameters=>Term2}
end,
Res2.
...
#{'built-in-standard-attributes':=Cindex1} = Val,
Cindex2 = case Val of
  #{'built-in-domain-defined-attributes':=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{'extension-attributes':=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{'built-in-standard-attributes'=>Term1},
Res2 = case Term2 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{'built-in-domain-defined-attributes'=>Term2}
end,
Res3 = case Term3 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{'extension-attributes'=>Term3}
end,
Res3.
...
Cindex1 = case Val of
  #{'country-name':=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{'administration-domain-name':=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{'network-address':=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex4 = case Val of
  #{'terminal-identifier':=Cindex4_0} -> Cindex4_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex5 = case Val of
  #{'private-domain-name':=Cindex5_0} -> Cindex5_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex6 = case Val of
  #{'organization-name':=Cindex6_0} -> Cindex6_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex7 = case Val of
  #{'numeric-user-identifier':=Cindex7_0} -> Cindex7_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex8 = case Val of
  #{'personal-name':=Cindex8_0} -> Cindex8_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex9 = case Val of
  #{'organizational-unit-names':=Cindex9_0} -> Cindex9_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{'country-name'=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{'administration-domain-name'=>Term2}
end,
Res4 = case Term3 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{'network-address'=>Term3}
end,
Res5 = case Term4 of
  asn1_NOVALUE -> Res4;
  _ -> Res4#{'terminal-identifier'=>Term4}
end,
Res6 = case Term5 of
  asn1_NOVALUE -> Res5;
  _ -> Res5#{'private-domain-name'=>Term5}
end,
Res7 = case Term6 of
  asn1_NOVALUE -> Res6;
  _ -> Res6#{'organization-name'=>Term6}
end,
Res8 = case Term7 of
  asn1_NOVALUE -> Res7;
  _ -> Res7#{'numeric-user-identifier'=>Term7}
end,
Res9 = case Term8 of
  asn1_NOVALUE -> Res8;
  _ -> Res8#{'personal-name'=>Term8}
end,
Res10 = case Term9 of
  asn1_NOVALUE -> Res9;
  _ -> Res9#{'organizational-unit-names'=>Term9}
end,
Res10.
...
#{surname:=Cindex1} = Val,
Cindex2 = case Val of
  #{'given-name':=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{initials:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex4 = case Val of
  #{'generation-qualifier':=Cindex4_0} -> Cindex4_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term2 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{'given-name'=>Term2}
end,
Res3 = case Term3 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{initials=>Term3}
end,
Res4 = case Term4 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{'generation-qualifier'=>Term4}
end,
Res4.
...
#{'extension-attribute-type':=Cindex1,'extension-attribute-value':=Cindex2} = Val,
...
Res1 = #{'extension-attribute-type'=>Term1,'extension-attribute-value'=>Term2},
Res1.
...
Cindex1 = case Val of
  #{'printable-address':=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{'teletex-string':=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{'printable-address'=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{'teletex-string'=>Term2}
end,
Res3.
...
enc_PDSParameter(Val, TagIn) ->
Cindex1 = case Val of
  #{'printable-string':=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{'teletex-string':=Cindex2_0} -> Cindex2_0;
...
'enc_ExtendedNetworkAddress_e163-4-address'(Val, TagIn) ->
   #{number:=Cindex1} = Val,
Cindex2 = case Val of
  #{'sub-address':=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
#{nAddresses:=Cindex4} = Val,
Cindex1 = case Val of
  #{pSelector:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{sSelector:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{tSelector:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{nAddresses=>Term4},
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{pSelector=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{sSelector=>Term2}
end,
Res4 = case Term3 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{tSelector=>Term3}
end,
Res4.
