...
%% Purpose: Encoding and decoding of the types in PKIX1Implicit88.
...
Cindex1 = case Val of
  #{keyIdentifier:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{authorityCertIssuer:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{authorityCertSerialNumber:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{keyIdentifier=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{authorityCertIssuer=>Term2}
end,
Res4 = case Term3 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{authorityCertSerialNumber=>Term3}
end,
Res4.
...
Cindex1 = case Val of
  #{notBefore:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{notAfter:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{notBefore=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{notAfter=>Term2}
end,
Res3.
...
#{policyIdentifier:=Cindex1} = Val,
Cindex2 = case Val of
  #{policyQualifiers:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{policyIdentifier=>Term1},
Res2 = case Term2 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{policyQualifiers=>Term2}
end,
Res2.
...
#{policyQualifierId:=Cindex1,qualifier:=Cindex2} = Val,
...
Res1 = #{policyQualifierId=>Term1,qualifier=>Term2},
Res1.
...
Cindex1 = case Val of
  #{noticeRef:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{explicitText:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{noticeRef=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{explicitText=>Term2}
end,
Res3.
...
#{organization:=Cindex1,noticeNumbers:=Cindex2} = Val,
...
Res1 = #{organization=>Term1,noticeNumbers=>Term2},
Res1.
...
enc_PolicyMappings_SEQOF(Val, TagIn) ->
   #{issuerDomainPolicy:=Cindex1,subjectDomainPolicy:=Cindex2} = Val,
...
Res1 = #{issuerDomainPolicy=>Term1,subjectDomainPolicy=>Term2},
Res1.
...
#{'type-id':=Cindex1,value:=Cindex2} = Val,
...
Res1 = #{'type-id'=>Term1,value=>Term2},
Res1.
...
#{partyName:=Cindex2} = Val,
Cindex1 = case Val of
  #{nameAssigner:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{partyName=>Term2},
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{nameAssigner=>Term1}
end,
Res2.
...
Cindex1 = case Val of
  #{cA:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{pathLenConstraint:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term2 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{pathLenConstraint=>Term2}
end,
Res2.
...
Cindex1 = case Val of
  #{permittedSubtrees:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{excludedSubtrees:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{permittedSubtrees=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{excludedSubtrees=>Term2}
end,
Res3.
...
#{base:=Cindex1} = Val,
Cindex2 = case Val of
  #{minimum:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{maximum:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{base=>Term1,minimum=>Term2},
Res2 = case Term3 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{maximum=>Term3}
end,
Res2.
...
Cindex1 = case Val of
  #{requireExplicitPolicy:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{inhibitPolicyMapping:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{requireExplicitPolicy=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{inhibitPolicyMapping=>Term2}
end,
Res3.
...
Cindex1 = case Val of
  #{distributionPoint:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{reasons:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{cRLIssuer:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{distributionPoint=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{reasons=>Term2}
end,
Res4 = case Term3 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{cRLIssuer=>Term3}
end,
Res4.
...
#{accessMethod:=Cindex1,accessLocation:=Cindex2} = Val,
...
Res1 = #{accessMethod=>Term1,accessLocation=>Term2},
Res1.
...
Cindex2 = case Val of
  #{onlyContainsUserCerts:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{onlyContainsCACerts:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex4 = case Val of
  #{onlySomeReasons:=Cindex4_0} -> Cindex4_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex5 = case Val of
  #{indirectCRL:=Cindex5_0} -> Cindex5_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex6 = case Val of
  #{onlyContainsAttributeCerts:=Cindex6_0} -> Cindex6_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{onlyContainsUserCerts=>Term2,onlyContainsCACerts=>Term3,indirectCRL=>Term5,onlyContainsAttributeCerts=>Term6},
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{distributionPoint=>Term1}
end,
