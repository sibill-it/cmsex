...
%% Purpose: Encoding and decoding of the types in AttributeCertificateVersion1.
...
#{acInfo:=Cindex1,signatureAlgorithm:=Cindex2,signature:=Cindex3} = Val,
...
Res1 = #{acInfo=>Term1,signatureAlgorithm=>Term2,signature=>Term3},
Res1.
...
#{subject:=Cindex2,issuer:=Cindex3,signature:=Cindex4,serialNumber:=Cindex5,attCertValidityPeriod:=Cindex6,attributes:=Cindex7} = Val,
Cindex1 = case Val of
...
Res1 = #{version=>Term1,subject=>Term2,issuer=>Term3,signature=>Term4,serialNumber=>Term5,attCertValidityPeriod=>Term6,attributes=>Term7},
Res2 = case Term8 of
  asn1_NOVALUE -> Res1;
