...
%% Purpose: Encoding and decoding of the types in PKIXAttributeCertificate.
...
#{acinfo:=Cindex1,signatureAlgorithm:=Cindex2,signatureValue:=Cindex3} = Val,
...
Res1 = #{acinfo=>Term1,signatureAlgorithm=>Term2,signatureValue=>Term3},
Res1.
...
#{version:=Cindex1,holder:=Cindex2,issuer:=Cindex3,signature:=Cindex4,serialNumber:=Cindex5,attrCertValidityPeriod:=Cindex6,attributes:=Cindex7} = Val,
Cindex8 = case Val of
  #{issuerUniqueID:=Cindex8_0} -> Cindex8_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex9 = case Val of
  #{extensions:=Cindex9_0} -> Cindex9_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{version=>Term1,holder=>Term2,issuer=>Term3,signature=>Term4,serialNumber=>Term5,attrCertValidityPeriod=>Term6,attributes=>Term7},
Res2 = case Term8 of
  asn1_NOVALUE -> Res1;
...
Cindex1 = case Val of
  #{baseCertificateID:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{entityName:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{objectDigestInfo:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{baseCertificateID=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{entityName=>Term2}
end,
Res4 = case Term3 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{objectDigestInfo=>Term3}
end,
Res4.
...
#{digestedObjectType:=Cindex1,digestAlgorithm:=Cindex3,objectDigest:=Cindex4} = Val,
Cindex2 = case Val of
  #{otherObjectTypeID:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{digestedObjectType=>Term1,digestAlgorithm=>Term3,objectDigest=>Term4},
Res2 = case Term2 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{otherObjectTypeID=>Term2}
end,
Res2.
...
Cindex1 = case Val of
  #{issuerName:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{baseCertificateID:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{objectDigestInfo:=Cindex3_0} -> Cindex3_0;
...
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{issuerName=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{baseCertificateID=>Term2}
end,
Res4 = case Term3 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{objectDigestInfo=>Term3}
...
#{issuer:=Cindex1,serial:=Cindex2} = Val,
Cindex3 = case Val of
  #{issuerUID:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{issuer=>Term1,serial=>Term2},
Res2 = case Term3 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{issuerUID=>Term3}
end,
Res2.
...
#{notBeforeTime:=Cindex1,notAfterTime:=Cindex2} = Val,
...
Res1 = #{notBeforeTime=>Term1,notAfterTime=>Term2},
Res1.
...
#{targetCertificate:=Cindex1} = Val,
Cindex2 = case Val of
  #{targetName:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{certDigestInfo:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{targetCertificate=>Term1},
Res2 = case Term2 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{targetName=>Term2}
end,
Res3 = case Term3 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{certDigestInfo=>Term3}
end,
Res3.
...
#{values:=Cindex2} = Val,
Cindex1 = case Val of
  #{policyAuthority:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
#{service:=Cindex1,ident:=Cindex2} = Val,
Cindex3 = case Val of
  #{authInfo:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{service=>Term1,ident=>Term2},
Res2 = case Term3 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{authInfo=>Term3}
end,
Res2.
...
#{roleName:=Cindex2} = Val,
Cindex1 = case Val of
  #{roleAuthority:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
#{policyId:=Cindex1} = Val,
Cindex2 = case Val of
  #{classList:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{securityCategories:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{policyId=>Term1,classList=>Term2},
Res2 = case Term3 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{securityCategories=>Term3}
end,
Res2.
...
Cindex1 = case Val of
  #{pathLenConstraint:=Cindex1_0} -> Cindex1_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex2 = case Val of
  #{permittedAttrs:=Cindex2_0} -> Cindex2_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex3 = case Val of
  #{excludedAttrs:=Cindex3_0} -> Cindex3_0;
  _ -> asn1__MISSING_IN_MAP
end,
Cindex4 = case Val of
  #{permitUnSpecified:=Cindex4_0} -> Cindex4_0;
  _ -> asn1__MISSING_IN_MAP
end,
...
Res1 = #{permitUnSpecified=>Term4},
Res2 = case Term1 of
  asn1_NOVALUE -> Res1;
  _ -> Res1#{pathLenConstraint=>Term1}
end,
Res3 = case Term2 of
  asn1_NOVALUE -> Res2;
  _ -> Res2#{permittedAttrs=>Term2}
end,
Res4 = case Term3 of
  asn1_NOVALUE -> Res3;
  _ -> Res3#{excludedAttrs=>Term3}
end,
Res4.
...
#{acIssuer:=Cindex1,acSerial:=Cindex2,attrs:=Cindex3} = Val,
...
Res1 = #{acIssuer=>Term1,acSerial=>Term2,attrs=>Term3},
Res1.
